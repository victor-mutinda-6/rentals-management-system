...
class HousesActivityTwo : AppCompatActivity() {
    lateinit var Listhouses: ListView
    lateinit var houses:ArrayList<House>
    lateinit var adapter: HouseAdapterTwo
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        houses = ArrayList()
        adapter = HouseAdapterTwo(this,houses)
        ...
        ref.addValueEventListener(object : ValueEventListener {
            ...
            override fun onCancelled(error: DatabaseError) {
                Toast.makeText(this@HousesActivityTwo,"DB is inaccessible",Toast.LENGTH_LONG).show()
            }
        })
